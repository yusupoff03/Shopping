...
<div>
    <form action="${pageContext.request.contextPath}/add-product/${userId}" method="post">
        ...
        <input type="text" name="manufacturer" placeholder="manufacturer" id="manufacturer">
        <input type="text" name="model" placeholder="model" id="model">
        <input type="number" name="balance" placeholder="balance" id="balance">
    ...
    <table class="table">
        ...
        <c:forEach items="${products}" var="product">
            <tr>
                ...
                <td>
                    <form action="${pageContext.request.contextPath}/products/delete/${userId}">
                        <input name="productId" type="hidden" value="${product.id}">
                        <button type="submit"><i class='bx bxs-message-x'></i></button>
                    </form>
                </td>
                <td>
                    <form action="${pageContext.request.contextPath}/products/edit/${userId}">
                        <input name="productId" type="hidden" value="${product.id}">
